            ...
            <!-- COPY the content from "tpl/" -->
              <div class="hbox hbox-auto-xs hbox-auto-sm">
                <div class="col">
                  ...
                  <!--小组信息-->  
                    <a href="" class="pull-left thumb-sm avatar m-l-n-md">
                     <img src="img/b18.jpg" alt="" align="absmiddle" title="Wooden Decals"/>
                    </a>
                    <div class="m-l-lg">
                      <div class="m-b-xs">
                        <a href class="h4">小组名称</a>
                        <span class="text-muted m-l-sm pull-right">
                          Just now
                        </span>
                      </div>
                      <div class="m-b">
                        <div>小组介绍：Lorem ipsum dolor sit amet, consecteter adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. ullamcorper sodales nisi nec adipiscing elit. Morbi id neque quam. Aliquam sollicitudin </div>
                        <div class="m-t-sm">
