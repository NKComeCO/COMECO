...
<!--  
	<c:if test="${empty requestScope.GetUser }">
		<script>
			window.location = "/COMECO/GetTopUsersServlet";
		</script>
	</c:if>
-->
						...
						<div class="padder">
							<div class="streamline b-l b-info m-l-lg m-b padder-v">
								<c:forEach items="${requestScope.recruitl }" var="recruit">
									...
									<div class="m-l-lg">
										<div class="m-b-xs">
											<a href class="h4">${recruit.}</a> <span
												class="text-muted m-l-sm pull-right"> Just now </span>
										</div>
										<div class="m-b">
											<div>小组介绍：Lorem ipsum dolor sit amet, consecteter
												adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
												laoreet. ullamcorper sodales nisi nec adipiscing elit. Morbi
												id neque quam. Aliquam sollicitudin</div>
											<div class="m-t-sm">
									...
									<ul class="list-group no-bg no-borders pull-in">
										...
										<li class="list-group-item"><a herf
											...
											<div class="clear">
												...
												<small class="text-muted">人物标签</small></li>
										<li class="list-group-item"><a herf
											class="pull-left thumb-sm avatar m-r"> <img
